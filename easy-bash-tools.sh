...
select menusel in "Desktop/Windows Manager in Kali Linux 2.0" "Software and System Tools" "Install Hacking Tools" "Update tools to latest version" "EXIT PROGRAM"; do
case $menusel in
